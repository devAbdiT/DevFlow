  ...
  tags: z
    .array(
      z
        ...
        .max(30, { message: "Tag cannot excedd 30 characters." })
    )
...
export const AccountSchema = z.object({
  ...
  providerAccountId: z.string().min(1, { message: "Provider ID is required." }),
});
...
export const GetQuestionsSchema = PaginatedSearchParamsSchema.extend({
